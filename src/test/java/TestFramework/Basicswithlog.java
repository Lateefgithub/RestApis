	...
	public class Basicswithlog {
		...
		public void Test1()
	 {
			...
			given().
				...
				param("radius","500").
				param("key","AIzaSyDgvC69cPZ5xGFytV49wWdAZzGmT2uSkKA").log().all().
				when().
				...
				header("Server", "pablo").and().header("Vary", equalTo("Accept-Language")).log().body();
